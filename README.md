...
#### 5. The staffs must ready the product for shipping and check if all the information about shipping is correct, The adress of the customer, the name of the customer. Now the product is shipped and the customer must wait for it to be delivered.
